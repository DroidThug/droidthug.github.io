...
! function($) {
  ...
  $.fn.onepage_scroll = function(options) {
    ...
    $.fn.transformPage = function(settings, pos, index) {
      if (typeof settings.beforeMove == 'function') settings.beforeMove(
        index);
      ...
      if ($('html').hasClass('ie8')) {
        ...
        $(this).css({
          "-webkit-transform": (settings.direction == 'horizontal') ?
            "translate3d(" + pos + "%, 0, 0)" : "translate3d(0, " + pos +
            "%, 0)",
          "-webkit-transition": "all " + settings.animationTime + "ms " +
            settings.easing,
          "-moz-transform": (settings.direction == 'horizontal') ?
            "translate3d(" + pos + "%, 0, 0)" : "translate3d(0, " + pos +
            "%, 0)",
          "-moz-transition": "all " + settings.animationTime + "ms " +
            settings.easing,
          "-ms-transform": (settings.direction == 'horizontal') ?
            "translate3d(" + pos + "%, 0, 0)" : "translate3d(0, " + pos +
            "%, 0)",
          "-ms-transition": "all " + settings.animationTime + "ms " +
            settings.easing,
          "transform": (settings.direction == 'horizontal') ?
            "translate3d(" + pos + "%, 0, 0)" : "translate3d(0, " + pos +
            "%, 0)",
          "transition": "all " + settings.animationTime + "ms " +
            settings.easing
        });
      }
      $(this).one(
        ...
        function(e) {
          if (typeof settings.afterMove == 'function') settings.afterMove(
            index);
        });
    }
    ...
    $.each(sections, function(i) {
      ...
      $(this).css({
        ...
        top: (settings.direction == 'vertical' || settings.direction !=
          'horizontal') ? topPos + "%" : 0
      });
    ...
    if (window.location.hash != "" && window.location.hash != "#1") {
      ...
      if (parseInt(init_index) <= total && parseInt(init_index) > 0) {
        ...
        if (settings.pagination == true) $(".onepage-pagination li a" +
    ...
    $(document).bind('mousewheel DOMMouseScroll MozMousePixelScroll',
      function(event) {
        ...
        if (!$("body").hasClass("disabled-onepage-scroll")) init_scroll(
          event, delta);
      });
